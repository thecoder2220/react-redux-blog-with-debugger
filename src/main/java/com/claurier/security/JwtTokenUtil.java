...
import com.claurier.common.utils.TimeProvider;
...
public class JwtTokenUtil implements Serializable {
    ...
    public LocalDate getIssuedAtDateFromToken(String token) {
        ...
        Date  dateIssuedAt = getClaimFromToken(token, Claims::getIssuedAt);
        return dateIssuedAt.toInstant().atZone(ZoneId.systemDefault()).toLocalDate();
    }
